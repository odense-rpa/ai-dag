...
# 📄 **utils.py (tomme funktioner der fejler tests)**

Her er en lille samling simple funktioner, som Copilot skal implementere gennem loopet.
De er *med vilje forkerte eller tomme*, så testene helt sikkert fejler.
...
def is_palindrome(text: str) -> bool:
    """
    Return True if 'text' is a palindrome (reads the same forward and backward).
...
Alle tre funktioner er simple, men *ikke trivielle*:
De giver Copilot noget at arbejde med i tests, implementering og debugging.

---

Hvis du vil, kan jeg også:

📌 lave en **færdig test_utils.py**, hvis du vil kontrollere øvelsen
📌 udforme øvelsen i printklar PDF
📌 tilføje et mini-introafsnit om “hvad er agentic loops?”
